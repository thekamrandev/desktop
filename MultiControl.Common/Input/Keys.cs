namespace MultiControl.Common.Input
{
    ...
    public enum Keys
    {
        ...
        /// <summary>The OEM plus key on a US standard keyboard.</summary>
        Oemplus = 187,
        
        /// <summary>The OEM comma key on a US standard keyboard.</summary>
        Oemcomma = 188,
        
        /// <summary>The OEM minus key on a US standard keyboard.</summary>
        OemMinus = 189,
        
        /// <summary>The OEM period key on a US standard keyboard.</summary>
        OemPeriod = 190,
        ...
        /// <summary>Used to pass Unicode characters as if they were keystrokes.</summary>
        Packet = 231,
